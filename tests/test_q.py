...
class TestQCall(TestCase):
    ...
    def test_q_basic(self):
        q = Q(id=8)
        r = q._resolve(TestQCall.DummyQuerySet(), QueryContext().push(IntFields, IntFields._meta.table()))
    ...
    def test_q_complex_char(self):
        ...
        r = q._resolve(TestQCall.DummyQuerySet(), QueryContext().push(CharFields, CharFields._meta.table()))
        self.assertEqual(
